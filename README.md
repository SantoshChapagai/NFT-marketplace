...
```
dfx canister call opend listItem '(principal "bd3sg-teaaa-aaaaa-qaaba-cai", 2)'
```
...
```
dfx canister call bkyz2-fmaaa-aaaaa-qaaaq-cai transferOwnership '(principal "bd3sg-teaaa-aaaaa-qaaba-cai", true)'
```
